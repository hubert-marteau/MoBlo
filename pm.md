...
Node not able to connect to the BC

 	Origin Node :

Creator of the BC

Naturally has admin rights

 	Admin :

Can give and revoke to anyone the rights :

issue, mine, activate, admin, connect, send receive
...
Node processing blocks of the BC

 	Connect :

Node able to connect to the BC

Able to see all the transactions of the BC

 	Send :

Node able to send new transaction to the BC

Necessarily able to connect

 	Receive :

Node able to receive transaction in the BC

Necessarily able to connect

 	Issue :

Node able to create new asset in the BC

Necessarily able to connect and receive
